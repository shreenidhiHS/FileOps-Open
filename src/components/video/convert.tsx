...
import { Upload, Download, Video, AlertCircle, Loader2, FileVideo } from "lucide-react";
...
export default function ConvertVideo() {
  ...
  const supportedFormats: FormatInfo[] = [
    {
      ...
      features: ['High quality', 'Universal support', 'Good compression'],
      quality: 'high',
      compression: true
    },
    {
      ...
      features: ['Lossless quality', 'Large file size', 'Windows compatible'],
      quality: 'medium',
      compression: false
    },
    {
      ...
      features: ['High quality', 'Apple devices', 'Professional use'],
      quality: 'high',
      compression: true
    },
    {
      ...
      features: ['Web friendly', 'Open source', 'Good compression'],
      quality: 'high',
      compression: true
    },
    {
      ...
      features: ['High quality', 'Multiple tracks', 'Open source'],
      quality: 'high',
      compression: true
    },
    {
      ...
      features: ['Small file size', 'Web streaming', 'Legacy support'],
      quality: 'medium',
      compression: true
    },
    {
    ...
    },
    {
      name: 'M4V',
      extension: 'm4v',
      description: 'iTunes Video format',
      features: ['High quality', 'DRM support', 'Apple ecosystem'],
      quality: 'high',
      compression: true
    }
  ];
  ...
  const convertVideo = async () => {
    ...
    try {
      ...
      if (result.success && result.dataUrl) {
        ...
        toast.success(`Video converted to ${selectedFormat.toUpperCase()} successfully!`);
      } else {
        toast.error(result.error || "Failed to convert video");
      }
    } catch (error) {
  ...
  const downloadConvertedVideo = () => {
    ...
    link.download = convertResult.fileName || 'converted.mp4';
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          >
            Convert video files between different formats with quality control
          </p>
        </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Upload Video & Conversion Settings
              </CardTitle>
              <CardDescription>
                Select a video file and choose target format
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              >
                <Video className="w-12 h-12 mx-auto mb-4" style={{ color: 'var(--muted-foreground)' }} />
            ...
            <CardContent className="space-y-4">
              {convertResult ? (
                <>
                  ...
                  {convertResult.dataUrl && (
                    <div className="border rounded-lg p-4" style={{ borderColor: 'var(--border)' }}>
                      ...
                      >
                        <source src={convertResult.dataUrl} type={`video/${convertResult.newFormat}`} />
                ...
                <div className="text-center py-12">
                  <Video className="w-16 h-16 mx-auto mb-4" style={{ color: 'var(--muted-foreground)' }} />
                  <p style={{ color: 'var(--muted-foreground)' }}>
                    Upload a video file to start converting
                  </p>
                </div>
              )}
            </CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {supportedFormats.map((format) => (
                <div key={format.extension} className="p-4 rounded-lg border" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--muted)' }}>
                  <div className="flex items-center gap-2 mb-2">
                    <FileVideo className="w-5 h-5" style={{ color: 'var(--primary)' }} />
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold mb-2" style={{ color: 'var(--foreground)' }}>Upload Video</h3>
                <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
              ...
              <div className="text-center">
                ...
                <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
                  Preview and download your converted video
                </p>
              </div>
            </div>
          </CardContent>
