...
import { Upload, Download, Image as ImageIcon, AlertCircle, Loader2, Minus, Eye } from "lucide-react";
...
export default function CompressImage() {
  ...
  const compressImage = async () => {
    ...
    try {
      ...
      if (result.success && result.dataUrl) {
        ...
        toast.success(`Image compressed successfully! ${result.compressionRatio?.toFixed(1)}% size reduction`);
      } else {
        toast.error(result.error || "Failed to compress image");
      }
    } catch (error) {
  ...
  const downloadCompressedImage = () => {
    ...
    link.download = compressResult.fileName || 'compressed.jpg';
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          >
            Reduce image file size while maintaining quality and visual appeal
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select an image file and adjust compression quality
              </CardDescription>
            </CardHeader>
              ...
              {compressResult ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p style={{ color: 'var(--muted-foreground)' }}>
                    Upload an image file to see compression results
                  </p>
                </div>
              )}
            </CardContent>
