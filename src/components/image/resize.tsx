...
import { Upload, Download, Image as ImageIcon, AlertCircle, Loader2, Maximize } from "lucide-react";
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 rounded-lg border" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--muted)' }}>
                <div className="text-center">
                  <Maximize className="w-8 h-8 mx-auto mb-2" style={{ color: 'var(--muted-foreground)' }} />
                  <h3 className="font-semibold mb-1" style={{ color: 'var(--foreground)' }}>
                    Coming Soon
                  </h3>
                  <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
                    Interactive resizing tool with dimension controls
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 rounded-full mx-auto mb-3 flex items-center justify-center" style={{ backgroundColor: 'var(--primary)' }}>
                  <Maximize className="w-6 h-6" style={{ color: 'var(--primary-foreground)' }} />
                </div>
                <h3 className="font-semibold mb-2" style={{ color: 'var(--foreground)' }}>Dimension Control</h3>
                <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold mb-2" style={{ color: 'var(--foreground)' }}>Aspect Ratio</h3>
                <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold mb-2" style={{ color: 'var(--foreground)' }}>Quality Control</h3>
                <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
